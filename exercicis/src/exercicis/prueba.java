...
public class prueba {
    public static void main(String[] args) {
        ...
        Ordenador[] ordenadores = {
            new Ordenador("Dell", "Inspiron"),
            new Ordenador("HP", "Pro Max", "Intel i7", 16, 1000),
            new Ordenador("Lenovo", "ThinkPad", "AMD Ryzen 7", 32, 512)
        };
    ...
    private static void mostrarOrdenadores(Ordenador[] ordenadores) {
